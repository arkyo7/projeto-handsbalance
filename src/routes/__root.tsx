...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Hands & Balance Wellness Center" },
      { name: "theme-color", content: "#0E7773" },
      { property: "og:site_name", content: "Hands & Balance Wellness Center" },
...
function RootComponent() {
  ...
  const isAppArea = pathname.startsWith("/admin") || pathname.startsWith("/auth");
